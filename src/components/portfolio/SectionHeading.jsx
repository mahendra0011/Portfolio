...
const SectionHeading = ({ eyebrow, title, description }) => (<motion.div initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-260px 0px" }} transition={{ duration: 0.12 }} className="mx-auto mb-10 max-w-2xl text-center sm:mb-16">
