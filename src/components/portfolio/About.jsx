  ...
  return (
    <section id="about" className="py-20 sm:py-24">
      <div className="container">
        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center lg:gap-12">
          <motion.div
          ...
          <div className="grid grid-cols-2 gap-4">
            {stats.map((s, i) => (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="glass rounded-lg p-6 text-center group hover:shadow-glow transition-shadow"
              >
                <div className="w-12 h-12 rounded-lg gradient-bg mx-auto mb-3 flex items-center justify-center group-hover:scale-110 transition-transform">
