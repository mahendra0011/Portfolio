...
const items = [
    ...
    },
    {
        ...
        description: "Consistently shipping code — 400+ commits across personal and full-stack project repositories.",
    },
];
const Achievements = () => (<section id="achievements" className="py-24 relative">
    <div className="container">
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        {items.map((item, i) => (<motion.div key={item.title} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.1 }} whileHover={{ y: -6 }} className="glass rounded-2xl p-6 flex gap-4 hover:shadow-glow transition-all group">
