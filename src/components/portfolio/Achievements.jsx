...
const items = [
  ...
  },
  {
    ...
    description: "Presented an IoT-based Fuel Theft Detection System focused on real-world problem solving.",
  },
  {
    Icon: Code2,
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        {items.map((item, i) => (
          <motion.div
            ...
            whileHover={{ y: -6 }}
            className="glass rounded-lg p-6 flex gap-4 hover:shadow-glow transition-all group"
          >
            <div className="w-12 h-12 shrink-0 rounded-lg gradient-bg flex items-center justify-center group-hover:scale-110 transition-transform">
