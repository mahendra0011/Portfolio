...
const Resume = () => (<section id="resume" className="py-24 relative">
    <div className="container">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="max-w-5xl mx-auto">
        ...
        <div className="glass rounded-2xl p-2 shadow-glow overflow-hidden">
          <object data={`${RESUME_URL}#view=FitH`} type="application/pdf" className="w-full h-[80vh] rounded-xl bg-background">
