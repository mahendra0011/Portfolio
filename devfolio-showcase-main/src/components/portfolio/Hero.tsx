        ...
        >
          <div className="relative">
            ...
            <motion.div
              ...
              className="absolute top-10 -left-6 glass rounded-2xl px-4 py-2 shadow-elegant"
            >
            ...
            <motion.div
              ...
              className="absolute bottom-20 -right-4 glass rounded-2xl px-4 py-2 shadow-elegant"
            >
            ...
            <motion.div
              ...
              className="absolute top-1/2 -right-10 glass rounded-2xl px-3 py-2 shadow-elegant text-xs font-semibold"
            >
              MERN
            </motion.div>
          </div>
